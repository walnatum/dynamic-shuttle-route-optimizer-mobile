...
//       >
//         {startMarker && (
//           <Marker coordinate={startMarker} title="Start" pinColor="#00FF00" />
//         )}
//         {destinationMarker && (
//           <Marker coordinate={destinationMarker} title="Destination" pinColor="#FF0000" />
//         )}
//         {routeCoordinates.length > 0 && (
//           <Polyline coordinates={routeCoordinates} strokeColor="#1E90FF" strokeWidth={5} />
//         )}
//         {smartRouteCoordinates.length > 0 && (
//           <Polyline coordinates={smartRouteCoordinates} strokeColor="#00FF00" strokeWidth={5} />
//         )}
//       </MapView>
