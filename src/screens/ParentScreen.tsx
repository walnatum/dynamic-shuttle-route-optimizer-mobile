...
//   const apiKey = 'AIzaSyBIq7bzSYsYJ65cLhtYsQTx_q0bBzRreWU'; // Replace with your Google Maps API key
//   const backendUrl = 'http://127.0.0.1:5000/get_route'; // Update if hosted on Render
...
//         Alert.alert('Error', `Backend error: ${backendData.error}`);
//         return;
//       }
...
//         <TextInput
//           style={styles.input}
//           placeholder="Start location (e.g., Makerere University, Kampala, Uganda)"
//           value={start}
//           onChangeText={setStart}
//         />
//         <TextInput
...
//                 <Text style={styles.timeText}>Total Score: {routeDetails.total_score.toFixed(2)}</Text>
//                 <Text style={styles.timeText}>Normalized Score: {routeDetails.normalized_score.toFixed(2)}</Text>
//                 <Text style={styles.timeText}>Traffic Risk: {routeDetails.avg_traffic_score.toFixed(2)}</Text>
//                 <Text style={styles.timeText}>Crash Risk: {routeDetails.avg_crash_score.toFixed(2)}</Text>
//                 <Text style={styles.timeText}>Weather Risk: {routeDetails.avg_weather_score.toFixed(2)}</Text>
//                 <Text style={styles.timeText}>Weather Conditions:</Text>
//                 {routeDetails.weather_conditions.map((condition, index) => (
//                   <Text key={index} style={styles.timeText}>
//                     {condition.segment}: {condition.weather}, {condition.temperature}
//                   </Text>
//                 ))}
//                 <Text style={styles.timeText}>High Crash Risk Segments:</Text>
//                 {routeDetails.crash_risk_segments.filter(seg => seg.risk_level === 'High').length > 0 ? (
//                   routeDetails.crash_risk_segments
//                     .filter(seg => seg.risk_level === 'High')
//                     .map((seg, index) => (
//                       <Text key={index} style={styles.timeText}>
//                         {seg.segment}: Score {seg.score}
//                       </Text>
//                     ))
//                 ) : (
//                   <Text style={styles.timeText}>- No high crash risk segments</Text>
//                 )}
//               </View>
//             )}
//             <Button title="Cancel" onPress={resetMap} />
...
//   const apiKey = 'AIzaSyBIq7bzSYsYJ65cLhtYsQTx_q0bBzRreWU'; // Replace with your actual Google Maps API key
...
//                 <Text style={styles.timeText}>Weather Conditions:</Text>
//                 {routeDetails.weather_conditions && routeDetails.weather_conditions.length > 0 ? (
//                   routeDetails.weather_conditions.map((condition, index) => (
//                     <Text key={index} style={styles.timeText}>
//                       {condition.segment}: {condition.weather}, {condition.temperature}
//                     </Text>
//                   ))
//                 ) : (
//                   <Text style={styles.timeText}>- No weather data available</Text>
//                 )}
//                 <Text style={styles.timeText}>High Crash Risk Segments:</Text>
//                 {routeDetails.crash_risk_segments && routeDetails.crash_risk_segments.filter(seg => seg.risk_level === 'High').length > 0 ? (
//                   routeDetails.crash_risk_segments
//                     .filter(seg => seg.risk_level === 'High')
//                     .map((seg, index) => (
//                       <Text key={index} style={styles.timeText}>
