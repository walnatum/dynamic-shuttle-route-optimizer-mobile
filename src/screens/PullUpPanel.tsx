...
//                   {msg.route && (
//                     <View style={styles.messageRouteTag}>
//                       <Text style={styles.messageRouteText}>{msg.route}</Text>
//                     </View>
//                   )}
//                 </View>
...
//                   onPress={() => upvoteMessage(msg.id)}
//                 >
//                   <Icon name="thumb-up" size={16} color="#007AFF" />
//                   <Text style={styles.upvoteText}>{msg.upvotes}</Text>
//                 </TouchableOpacity>
//               </View>
//             ))}
//           </ScrollView>
...
//               <Icon name="directions-bus" size={20} color="#007AFF" />
//               <Text style={styles.selectorLabel}>Route:</Text>
//               <TouchableOpacity 
//                 style={styles.routeOption} 
//                 onPress={() => setSelectedRoute("North Campus Express")}
//               >
//                 <Text style={selectedRoute === "North Campus Express" ? styles.selectedRouteText : styles.routeOptionText}>North</Text>
//               </TouchableOpacity>
//               <TouchableOpacity 
//                 style={styles.routeOption} 
//                 onPress={() => setSelectedRoute("South Campus Loop")}
//               >
//                 <Text style={selectedRoute === "South Campus Loop" ? styles.selectedRouteText : styles.routeOptionText}>South</Text>
//               </TouchableOpacity>
//               <TouchableOpacity 
//                 style={styles.routeOption} 
//                 onPress={() => setSelectedRoute("East-West Connector")}
//               >
//                 <Text style={selectedRoute === "East-West Connector" ? styles.selectedRouteText : styles.routeOptionText}>East-West</Text>
//               </TouchableOpacity>
//             </View>
...
//                 placeholder="Share an update about this route..."
//                 value={message}
...
//         </TouchableOpacity>
//         <TouchableOpacity style={styles.floatingButton} onPress={goToTraffic}>
//           <Icon name="traffic" size={20} color="#fff" />
//           <Text style={styles.buttonText}>Traffic</Text>
//         </TouchableOpacity>
//         <TouchableOpacity 
...
//         >
//           <Icon name={activeTab === "routes" ? "chat" : "map"} size={20} color="#fff" />
