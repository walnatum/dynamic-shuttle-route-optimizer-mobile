...
const HomeScreen = () => {
  ...
  // Sample parking locations around Kampala
  const parkingLocations = [
    { latitude: 0.313611, longitude: 32.581111, name: "Parking Lot A" },
    { latitude: 0.316388, longitude: 32.582778, name: "Parking Lot B" },
    { latitude: 0.314167, longitude: 32.586111, name: "Parking Lot C" },
    { latitude: 0.311111, longitude: 32.589444, name: "Parking Lot D" },
    { latitude: 0.310000, longitude: 32.583333, name: "Parking Lot E" },
  ];
